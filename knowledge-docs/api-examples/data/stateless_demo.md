# API example: stateless demo

Runnable example script `data/stateless_demo.py` from the public-docs repo (api-examples/).
...
POLYGON_DELEGATORS: list[str] = [
    "0x5f22b773177799ae046ed7460498539621a38431"
]
