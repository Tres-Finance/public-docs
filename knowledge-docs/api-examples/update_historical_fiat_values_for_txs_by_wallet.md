# API example: update historical fiat values for txs by wallet

Runnable example script `update_historical_fiat_values_for_txs_by_wallet.py` from the public-docs repo (api-examples/).
