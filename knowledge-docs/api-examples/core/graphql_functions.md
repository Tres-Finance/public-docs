# API example: graphql functions

Runnable example script `core/graphql_functions.py` from the public-docs repo (api-examples/).
...
def get_sub_transactions_data_in_account_context(
    ...
    belongs_to_identifiers: Optional[list[str]] = None,
    ...
    variables = dict(
        ...
        belongsTo_Identifier_In=belongs_to_identifiers if belongs_to_identifiers else None,
