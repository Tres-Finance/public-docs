# API example: update historical fiat values for txs by asset class

Runnable example script `update_historical_fiat_values_for_txs_by_asset_class.py` from the public-docs repo (api-examples/).
