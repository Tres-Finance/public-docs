# API example: gather daily cosmos generated rewards

Runnable example script `gather_daily_cosmos_generated_rewards.py` from the public-docs repo (api-examples/).
