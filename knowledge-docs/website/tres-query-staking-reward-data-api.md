# TRES Query Staking Reward Data API

Source: https://tres.finance/tres-query-staking-reward-data-api/

TRES QUERY

## Get accurate, structured data for your daily staking commission & rewards

Leverage the power of TRES’ Financial Data Lake and create powerful staking reward performance reports for your clients.

## The TRES Query Staking Data API enables you to

Collect, parse and enrich staking data cross onchain-transactions and external vaults.

Calculate & reconcilie generated rewards from claimed & accrued rewards.

Consolidate different protocols into a unified data-model for easy development.

Leverage TRES’ Financial Data Lake and power your products and services with our contextual Web3 data.

Unlock new revenue streams by easily launching new chains & protocols.

## Transform the way you manage your Web3 finances.

### Supporting 220+ networks.

Onboard any wallet, asset, custodian or exchange. Quickly create a single source of truth for your Web3 financial activity.

### Get useable insights.

Understand the exact context for any transaction or asset activity. Reduce 90% of manual spreadsheet work.

### Generated rewards.

With real-time data on generated rewards, stakeholders can make informed decisions about their staking strategies and maximize their returns.

### Daily APR.

TRES Query offers a comprehensive view of the Daily Annual Percentage Rate (APR), enabling delegators and validators to stay informed about the performance of their staking activities.

### Staking ledger breakdown.

Users can now access a detailed breakdown of their staking ledger, facilitating a clear understanding of their financial position and performance over time.

### Close your books, fast.

Reconcile transactions in minutes, not days. Build monthly reports and export to any format - or better yet, synch directly to your ERP system.

## Build our staking reward data directly into your product, dashboard or reporting workflow

- Leverage the power of TRES’ Financial Data Lake, and create powerful staking reward performance reports for your clients.

- Remove manual reporting work and completely automate your reporting workflows.

## TRES FinOS Dashboard Widget

- See staking performance at a glance, and get an overview of your reward & commission data – directly in the TRES FinOS platform.

- Unlock deep staking reward data and understand exactly how your DeFi and staking positions were created.

## Bringing clarity to our customers & partners
...
"TRES has been a great partner to OP Labs to streamline our digital asset accounting. TRES worked with us to implement fair market value tracking in 2025 allowing us to drastically improve our efficiency and maintain a very tight close process."
...
## Powered by the TRES Financial Data Lake

Our Web3 financial data lake is built to scale with your business.

- Processed Monthly $14B+

- Number of Processed Transactions 100M+

- Assets under Management $20B+

## Stay compliant, stay ahead.Reshape how your company interacts with digital asset data.
